...
function displayPics(){
  ...
  // because it refers to the nloch it is inside which is in this case the function displayPics() so when clarify it or use it outside that function it would give an error but when we were using `var` it could give a spot on the clock of the hall code too not only tinside the function. 
  console.log(viewed);
